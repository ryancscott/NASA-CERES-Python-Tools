...
file1 = 'CER_CRS_Terra-FM1-MODIS_Edition2G_023034.2010062012'
...
file2 = 'CER_CRS4_Terra-FM1-MODIS_GH4_2222TH.2010062012'
...
lat, lon, p_levels, time_obs = ceres.read_crs_geolocation(file_path=file_path1)
...
field2, var2, units2, lev2 = ceres.read_crs_dev_var(file_path=file_path2, vararg=0, levarg=1, fill=1)
...
difference = ceres.compute_diff(field2=field2, field1=field1)
...
ceres.plot_swath(lon=lon, lat=lat, field=difference, nrows=1, ncols=1, cen_lon=0,
           ...
           cmap=colormap, cmap_lims=cmap_lim, date=date, date_str=date_str,
           nightshade=1, title_str=title_str)

title_str = 'CERES ' + ceres.get_platform(file1) + ' CRS'
...
ceres.histogram_scatterplot(field1, field2, var1, lev1, date_str, ceres.get_platform(file1))
